 ...
 *   by hook according to WinkelDefaultSkinVersionForNewAccounts. See Hooks and skin.json. The user
 *   may then change the preference at will.
 *
 * - Site configuration default. The default is controlled by WinkelDefaultSkinVersion and
 *   WinkelDefaultSkinVersionForExistingAccounts based on login state. The former is used
