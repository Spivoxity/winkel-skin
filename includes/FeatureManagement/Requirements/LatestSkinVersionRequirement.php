...
namespace Winkel\FeatureManagement\Requirements;

use Winkel\Constants;
use Winkel\FeatureManagement\Requirement;
use Winkel\SkinVersionLookup;
 ...
 *   to the `WinkelDefaultSkinVersionForNewAccounts` and
 *  `WinkelDefaultSkinVersionForExistingAccounts` config values. See the `Winkel\Hooks` class and
 *  `skin.json`.
 *
 ...
 *
 * - Site configuration default. The default is controlled by the `WinkelDefaultSkinVersion` config
 *   value. This is used for anonymous users and as a fallback configuration. See `skin.json`.
 *
 * This majority of this class is taken from Stephen Niedzielski's `Winkel\SkinVersionLookup` class,
 * which was introduced in `d1072d0fdfb1`.
 *
 * @unstable
 *
 * @package Winkel\FeatureManagement\Requirements
 * @internal
 */
