var collapsibleTabs = require( '../skins.winkel.legacy.js/collapsibleTabs.js' ),
	winkel = require( '../skins.winkel.legacy.js/winkel.js' ),
 ...
 * render in their terminal state on page load. By adding the `winkel-animations-ready` class to the
...
function enableCssAnimations( document ) {
	document.documentElement.classList.add( 'winkel-animations-ready' );
}
